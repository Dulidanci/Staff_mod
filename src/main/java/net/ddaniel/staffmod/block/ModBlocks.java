package net.ddaniel.staffmod.block;

import net.ddaniel.staffmod.StaffMod;
import net.ddaniel.staffmod.block.custom.BlueprintPlanksBlock;
import net.ddaniel.staffmod.block.custom.FadingLightBlock;
